# Only 14% of Self-Service Issues Get Resolved. Your Portal Has a $104M Problem.

**Gartner published the number. CIO Magazine quantified the fallout. Here's what it means for your service desk.**
...
- **81% of customers try self-service first** before contacting a live agent — meaning the intent is there, but the execution fails
...
**Source:** [Gartner — Only 14% of Customer Service Issues Fully Resolved in Self-Service (2024)](https://www.gartner.com/en/newsroom/press-releases/2024-08-19-gartner-survey-finds-only-14-percent-of-customer-service-issues-are-fully-resolved-in-self-service)
...
Conversational AI interfaces let users describe what they need in plain language — text or voice, in any language. The AI handles the translation from natural language to structured data: identifying the right service desk, matching the request type, collecting required fields, and creating the ticket.
...
**Source:** [Gartner — Agentic AI Prediction (March 2025)](https://www.gartner.com/en/newsroom/press-releases/2025-03-05-gartner-predicts-agentic-ai-will-autonomously-resolve-80-percent-of-common-customer-service-issues-without-human-intervention-by-20290)
